...
if __name__ == "__main__":
    ...
    print('RRMSE of GMV: ', np.round(gmv_rrmse, 5))
    ...
    print('RRMSE of age: ', np.round(age_rrmse, 5))
    ...
    print('RRMSE of GMV: ', np.round(both_gmv_rrmse, 5))
    print('Average: ', np.average(both_gmv_rrmse), '\n')
    print('RRMSE of age: ', np.round(both_age_rrmse, 5))
